...
- *Essentially the objective function calculates expected amount of metadata per second*
...
Calculate objective function for each file in directory-->Insert file;
D-->E;
