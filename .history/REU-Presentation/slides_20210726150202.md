...
## CDIAC Pub8
- The Carbon Dioxide Information Analysis Center (CDIAC) was a data archive supported by the DOE where enviromental researchers would publish data
  - Often the researchers would just "throw" the data in, and in an unorganized fahsion
  - Large Heterogenous data repository (500 gb)
  - Data now transitioned to Environmental System Science Data Infrastructure for a Virtual Ecosystem (ESS-DIVE) by Lawrence Livermore National Laboratory
- Annual publications known as "Pubs" with new data
- In this work we use CDIAC's Pub8
  - Approximately 60 GB and 20,427
